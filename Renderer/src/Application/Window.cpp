...
bool Log::forceScroll = true;
std::vector<std::string> Log::text;

std::string TextEditor::openFileName = "";
bool TextEditor::textEditorOpen = false;
bool TextEditor::hasFocus = false;
ImVector<char> TextEditor::source;

bool EngineViewport::hasFocus = false;
glm::vec2 EngineViewport::viewportDim;

float Grid::maxRenderDistance = 250;
